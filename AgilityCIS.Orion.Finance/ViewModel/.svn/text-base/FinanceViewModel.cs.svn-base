...
namespace AgilityCIS.Orion.Customers.ViewModel
{
    ...
    public class FinanceViewModel : BaseViewModel, INavigationAware
    {
        ...
        {
            CustomerNoSearchCriteria.CustomerNo = customer.CustomerNo;
        ...
        public void SaveCustomerEventHandler(Customer customer)
        {
            SaveCustDetails(null);
        }

        public void NextCustomerEventHandler(Customer customer)
        {
            LoadNextCustomerDetails(null);
        }
        public void PreviousCustomerEventHandler(Customer customer)
        {
            LoadPreviousCustomerDetails(null);
        }
        public void FirstCustomerEventHandler(Customer customer)
        {
            LoadFirstCustomerDetails(null);
        }
        public void LastCustomerEventHandler(Customer customer)
        {
            LoadLastCustomerDetails(null);
        }
        public void SearchCustomerEventHandler(Customer customer)
        {
            SearchCustNo(null);
        }
